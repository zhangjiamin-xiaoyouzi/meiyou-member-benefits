...
export const mockTemplates: Template[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { id: 'comp_102', name: '会员限时福利', key: 'flash_sale', description: '配置商品多轮预约与限量抢购（如沪上阿姨奶茶）', enabled: true, required: false },
      { id: 'comp_107', name: '会员专属礼', key: 'exclusive_gift', description: '配置会员专属权益商品（如成人洁牙与儿童涂氟、全棉礼包）', enabled: true, required: false },
      { id: 'comp_106', name: '会员专属0元购', key: 'free_purchase', description: '配置返现商品，会员下单后返现', enabled: true, required: false },
      { id: 'comp_103', name: '会员专属生活券包', key: 'free_benefit', description: '配置会员专属生活券包（如：美团外卖红包、古茗88折券）', enabled: true, required: false },
