...
export const mockTemplates: Template[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { id: 'comp_107a', name: '会员专属礼', key: 'welfare_product', description: '配置福利商品', enabled: true, required: false, maxCount: 5 },
      { id: 'comp_107b', name: '会员专属生活券包', key: 'welfare_product', description: '配置福利商品', enabled: true, required: false, maxCount: 5 },
