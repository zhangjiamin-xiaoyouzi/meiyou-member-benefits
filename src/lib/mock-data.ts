...
export const mockTemplates: Template[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { id: 'comp_102', name: '会员限时福利', key: 'flash_sale', description: '配置福利多轮预约与限量抢购（如沪上阿姨奶茶）', enabled: false, required: false },
      { id: 'comp_107', name: '会员专属礼', key: 'exclusive_gift', description: '配置会员专属权益福利（如成人洁牙与儿童涂氟、全棉礼包）', enabled: false, required: false },
